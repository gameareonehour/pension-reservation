...
type ServerInterface interface {
	// カタログAPI
	// (GET /catalog)
	GetCatalog(c *fiber.Ctx, params GetCatalogParams) error
	// 最新リリースノート取得API
	// (GET /release-notes)
...
func (siw *ServerInterfaceWrapper) GetCatalog(c *fiber.Ctx) error {
	...
	return siw.Handler.GetCatalog(c, params)
}
